  ...
  static public function getStoragePath():String {
      if (storagePath != null && storagePath.length > 0) {
          return storagePath;
			    ...
			    if (!FileSystem.exists(strangePath + "/com.kokosh.vswhitty") || !FileSystem.exists(strangePath + "/com.kokosh.vswhitty/assets")) {
				      if (!FileSystem.exists(strangePath + "/com.kokosh.vswhitty")) {
				          FileSystem.createDirectory(strangePath + "/com.kokosh.vswhitty");
				      }
				      if (!FileSystem.exists(strangePath + "/com.kokosh.vswhitty/assets")) {
				          FileSystem.createDirectory(strangePath + "/com.kokosh.vswhitty/assets");
				      }
			    }
			    storagePath = strangePath + "/com.kokosh.vswhitty/";
		  }
		  return storagePath;
	}
